    ...
    <div className="flex flex-col gap-16 pb-20">
      ...
      <section className="px-4 container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
                { name: 'Jane Doe', role: 'CEO & Co-Founder', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBaYBW-8qjfIqeEfp6W6DEWQ7Vxktb16kTkgkD48fO_X_dklV_1R9D6Qdum87XBFYwdvxldEFKayHO9NARSgzfiXykarg2PIXEwq0TTsLrJEfrgtTwbCT6djkzCK_jdi6DvJ9Z2tw1w0MgVY9I7UX4Dlp69f3IsNyWGo-s2ODVfn1s4Ps-CEgQQNpATkhI33oZ8F5klV3pWDCsWhDbYRwcwwOnokdPyze8s94_QmbxmAhKPny_1jnnSAUTRgkxy99iequXzHDmNAA8y' },
                { name: 'John Smith', role: 'CTO & Co-Founder', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBYd3xCEQszxZaXLQJJggOLxPfb4nL6f_rKTaysHNg55ZPaF3CYrDfnPCbI40mbpdbCLMcYQKXnDGslbmQIn9gCELUo1QkMifYTMC_JkQDNBvwLQkN2xgQJndcxmVDLI43vYa3jzveR858sAdkulvHt8oQ-RfeF7g9IGOgPVZcDbvxAt5y2yk1iA4ryZK5GZ9uyhFEZUWgEjkqE9b1CUoiKGExupiPnbIrHZTf7dd0mdfC8O3UrqRdd17YS73Iwf0D3r5njqtZZvO8I' },
                ...
                { name: 'Michael Brown', role: 'Lead AI Engineer', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB-BS9FoiRtXb-eAVTsi0uanX3YFgbxLosGiru4bTyEQ_SU5NdCtcSsnTmkklLEl6fm3_U5GqbjZ2KXtIW0Aa45j1Y6wna4PxoTc5QDwoOCu5YxYwNHvo1JGSNPfsNo0YHFY-srAoMLLjt1QoajVt0ywTccsahMtvtpfTVUJuoQkNx3jCCbYCcboNh256qvqpy8nIKGPWP7nYZDoXi_oKcW32kxS3DjidlafeOkbZP7TvdpkTbM-8Qkz81lxafFytSgdOayyqx0iBBx' }
            ].map((member, i) => (
